								...
								<div  class="panel-body pb-0">
									<div  class="tab-struct custom-tab-1">
										<ul role="tablist" class="nav nav-tabs nav-tabs-responsive" id="myTabs_8">
											...
											<li  role="presentation" class="next"><a aria-expanded="true"  data-toggle="tab" role="tab" id="follo_tab_8" href="#follo_8"><span>AMO<span class="inline-block">(246)</span></span></a></li>
                                                                                            ...
                                                                                            while ($row = mysqli_fetch_array($result)) 
                                                                                            {
                                                                                                $output .= '  
                                                                                                         <tr>  
                                                                                                              ...
                                                                                                              <td>
                                                                                                                          <a name="edit" value="Edit" id="' . $row["id"] . '" class="pr-10 edit_data" data-toggle="tooltip" title="edit" >
                                                                                                                            <i class="fa fa-pencil"></i>
                                                                                                                          </a>
                                                                                                                          <a name="view" value="view" id="' . $row["id"] . '" class="pr-10 edit_data" data-toggle="tooltip" title="view" >
                                                                                                                            <i class="fa fa-eye"></i>
                                                                                                                          </a>
                                                                                                                          <a name="view" value="view" id="' . $row["id"] . '" class="pr-10 edit_data" data-toggle="tooltip" title="send SMS" >
