<?php
//maake conncetion with db
$servername = "localhost";
$username = "root";
$password = "";
$dbname = "karengata_cims";

// Create connection
$conn = mysqli_connect($servername, $username, $password, $dbname);

//select db
//msql_select_db('locations');

$sql="SELECT * FROM transactions";


$records = mysqli_query($conn, $sql);
//$records=msql_query($sql);
...
mysql_select_db("karengata_cims") or die(mysql_error());
?>
								...
								<div  class="panel-body pb-0">
									<div  class="tab-struct custom-tab-1">
										<ul role="tablist" class="nav nav-tabs nav-tabs-responsive" id="myTabs_8">
											<li class="active" role="presentation"><a  data-toggle="tab" id="profile_tab_8" role="tab" href="#profile_8" aria-expanded="false"><span>Trust Funds</span></a></li>
											<li  role="presentation" class="next"><a aria-expanded="true"  data-toggle="tab" role="tab" id="follo_tab_8" href="#follo_8"><span>Income<span class="inline-block"></span></span></a></li>
											<li role="presentation" class=""><a  data-toggle="tab" id="photos_tab_8" role="tab" href="#photos_8" aria-expanded="false"><span>Expenditure</span></a></li>
											<li role="presentation" class=""><a  data-toggle="tab" id="earning_tab_8" role="tab" href="#earnings_8" aria-expanded="false"><span>Budgets</span></a></li>
											<li role="presentation" class=""><a  data-toggle="tab" id="settings_tab_8" role="tab" href="#settings_8" aria-expanded="false"><span>Requisitions</span></a></li>

											<li role="presentation" class=""><a  data-toggle="tab" id="earning_tab_8" role="tab" href="#earnings_8" aria-expanded="false"><span>Receipts</span></a></li>
											<li role="presentation" class=""><a  data-toggle="tab" id="settings_tab_8" role="tab" href="#settings_8" aria-expanded="false"><span>Invoices</span></a></li>
							...
							<!--div class="panel-wrapper collapse in"-->
								<!--div class="panel-body"-->
									<div class="table-wrap">
										...
										<!--table id="datable_1" data-toggle="table" id="datable_2" class="table table-hover table-bordered display pb-30"-->




											<!--table id="example" data-toggle="table" data-buttons-class='default btn-sm btn-outline' data-pagination="true" data-search="true" class="table table-hover display  pb-30" data-tablesaw-mode="columntoggle" -->
...
//$records=msql_query($sql);
												...
												while($transactions = mysqli_fetch_assoc($records)){
...
<!--td> <div style="display: flex; align-items: center;file"><span style="border-radius: 50%; width: 8px; height: 8px; margin-right: 8px; background-color: rgb(51, 221, 34);"></span>In progress</div> </td-->
                          
													<?php  
													echo "<td>".$transactions['user_nm']."</td>";

													echo "<td>".$transactions['department']."</td>";

													echo "<td>".$transactions['item_name']."</td>";

													echo "<td>".$transactions['amount']."</td>";

													
													
													echo "<td>".$transactions['code']."</td>";
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											...
											<!--table id="datable_1" data-toggle="table" data-buttons-class='default btn-sm btn-outline' data-pagination="true" data-search="true" class="table table-hover display  pb-30" -->
...
//$records=msql_query($sql);
												...
												while($transactions2 = mysqli_fetch_assoc($records)){
													
													
													echo "<tr>";
													echo "<td>".$transactions2['id']."</td>";
												?>
...
<!--td> <div style="display: flex; align-items: center;file"><span style="border-radius: 50%; width: 8px; height: 8px; margin-right: 8px; background-color: rgb(51, 221, 34);"></span>In progress</div> </td-->
													...
													<?php  
													echo "<td>".$transactions2['user_nm']."</td>";

													echo "<td>".$transactions2['department']."</td>";

													echo "<td>".$transactions2['item_name']."</td>";

													echo "<td>".$transactions2['amount']."</td>";

													
													
													echo "<td>".$transactions2['code']."</td>";
													
													
													
													echo "<td>".$transactions2['status']."</td>";
												...
												<div class="col-md-12">
													<div class="pt-20">
														...
														<!--table id="example" data-toggle="table" data-buttons-class='default btn-sm btn-outline' data-pagination="true" data-search="true" class="table table-hover display  pb-30"-->
															...
															<!--table id="example"  data-toggle="table"  data-pagination="true"    -->
																...
																<thead>
																	...
																	<tr>
																		...
																		<th data-sortable="true">Member No.</th>
																		<th data-sortable="true">Gender</th>
																		<th data-sortable="true">Phone</th>
																		<th data-sortable="true">Entry Mode</th>
																		<th data-sortable="true">Status</th>
														...
														<tbody>
		  													<!--tr-->
																	...
																	while($userdetails = mysqli_fetch_array($records)){
																		...
																		echo "<td>".$userdetails['member_no']."</td>";
																		
																		echo "<td>".$userdetails['gender']."</td>";
																		
																		echo "<td>".$userdetails['phone']."</td>";
																		
																		echo "<td>".$userdetails['entry_mode']."</td>";

																		echo "<td>".$userdetails['comments_remarks']."</td>";
