                      ...
                      <div class="row">
                        <div class="table-wrap">
											<table id="footable_2" class="table" data-paging="true" data-filtering="true" data-sorting="true">
												<thead>
												<tr>
													<th data-name="id" data-breakpoints="xs" data-type="number">Qty</th>
													<th data-name="firstName">Item</th>
													<th data-name="lastName">Vendor</th>
													<th data-name="jobTitle" data-breakpoints="xs">Description</th>
													<th data-name="startedOn" data-breakpoints="xs sm" data-type="date" data-format-string="MMMM Do YYYY">Unit Price</th>
													<th data-name="dob" data-breakpoints="xs sm md" data-type="date" data-format-string="MMMM Do YYYY">Subtotal</th>
												</tr>
												</thead>
												<tbody>
												<tr data-expanded="true">
													...
													<td>Select Vendor</td>
													<td>Type Description of item</td>
