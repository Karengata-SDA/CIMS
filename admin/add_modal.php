...
error_reporting(0);
    ...
    $ind = "real";
    /*
     * Nevertheless, 2017 finished with renewed interest in Noah’s Ark being generated by media reports(k) of statements emanating from 
     * The Geoscience Research Institute, which is sponsored by the Seventh-day Adventist Church, which claims that a 2010 expedition to 
     * Mount Ararat in Turkey, carbon dated timbers found there to 4,800 years ago.
     * 
     * Ivory Lady of York
     * 
                    ...
                    <form method="POST" id="add_receipt" action="addrecp.php">
                                    ...
                                    <input type="text" oninput='onInput()' list="users" id="user" name="user" class="form-control" placeholder="" autocomplete="off">
                                        ...
                                        <datalist id="users">                                        
                                            <?php
                                                if($set == "all")
                                                {
                                                    $sql22 = "SELECT * FROM `userdetails` WHERE `organisation_id` = '$orgid' AND `comments_remarks` != 'Deceased' ORDER BY `name` ASC"; //TODO: Add dynamic `role` clause.
                                                }
                                                else
                                                {
                                                ...
                                                {
                                                    $user_id2 = $row22["id"];
                                                    $user_name = trim($row22["firstname"])." ".trim($row22["middlename"])." ".trim($row22["lastname"]);
                                                    $other_names = $row22["middlename"]." ".$row22["lastname"];
                                                    $user_ad2 = $row22["address"];
                                                    $user_phone = trim($row22["phone"]);
                                                    $user_ph2 = $row22["phone"];
                                                    $user_dp2 = $row22["department"];
                                                    $user_memno = trim($row22["member_no"]);
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                <input type="text" class="form-control" name="item1" id="currency-field" pattern="[a-zA-Z\s]{3,}), ([a-zA-Z\s]*{3,}), ([0-9]{4}" value="" data-type="text" autocomplete="false" placeholder="Name" autocomplete="off">
                            </div> 
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" class="form-control" name="amount1" id="currency-field" pattern="^(\()?[0-9]+(?>,[0-9]{3})*(?>\.[0-9]{2})?(?(1)\))$" value="" data-type="currency" placeholder="Amount" autocomplete="off">
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                <input type="text" class="form-control" name="item2" value="" autocomplete="false" placeholder="Name" autocomplete="off">
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                <input type="text" class="form-control" name="item3" value="" readonly onfocus="this.removeAttribute('readonly');" placeholder="Name" autocomplete="off">
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                <input type="text" class="form-control" name="item4" value="" placeholder="Name" autocomplete="off">
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                <input type="text" class="form-control" name="item5" value="" placeholder="Name" autocomplete="off">
                            </div> 
