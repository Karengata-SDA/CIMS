...
if($request_method == "POST")
{
    ...
    {        
        if($endpoint == "authenticate" || $endpoint == "settings" || $endpoint == "programme" || $endpoint == "login" || $endpoint == "members" || $endpoint == "registration" || $endpoint == "profile" || $endpoint == "departments" || $endpoint == "accounts" || $endpoint == "collections" || $endpoint == "verification" || $endpoint == "search" || $endpoint == "message" || $endpoint == "messages" || $endpoint == "statements" || $endpoint == "products" || $endpoint == "revenues" || $endpoint == "transaction" || $endpoint == "transactions" || $endpoint == "dashboard" || $endpoint == "verification_mpesa")
        {
            if($endpoint == "login")
            {
                $username = $parameter2;
...
Please keep time.";
    ...
    //                    }
            ...
            elseif($endpoint == "verification")
            {
                ...
                if($phoneno == "87y786" && $emailad == "908907")
                {
