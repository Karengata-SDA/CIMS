                            ...
                            for($i=0; $i<$count; $i++)
                            {
                                ...
                                if($user != "")
                                {
                                    ...
                                    if($nangoz != "")
                                    {
                                        ...
                                        /*$ujumbe = "The Steps to Christ Series will not air today and next Wednesday to allow for preparation for the upcoming Evangelism Campaign.

To this end, today we will air a re-run of the Sermon titled - CAN GOD TRUST YOU? Click the link below to follow.

https://youtu.be/ovV913yCBSY
...
Be Blessed!\n\nThe Pastorate,\nKarengata SDA Church.";*/
    ...
    SMS/Call: 020 200 88 88
                                         */
                                         ...
                                         $ujumbe = "We are on day 4 of the Evangelism week.\nToday's topic is: QUARANTINED! 

Set a reminder for 8PM and join us : https://youtu.be/avAouRcYCOs,\n\nKarengata PM. Dept.\n\nSMS/Call: 020 200 88 88\n";
